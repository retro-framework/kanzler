...
export function setSelectedHeadRefHash(
  newHeadRefHash: string
...
export function odbvCheckpointsAvailable(
  checkpoints: types.ICheckpoint[]
...
export function changeSelectedODBVCheckpoint(
  checkpoint: types.ICheckpoint
